...
If your answer was connect(), then yes Context replaces Redux.
But if you need any of the other Redux features, then NO
...
- Our job doesn't end with just picking the right library/framework
...
- So choose between Composition/ Context / Redux wisely :thumps_up:
